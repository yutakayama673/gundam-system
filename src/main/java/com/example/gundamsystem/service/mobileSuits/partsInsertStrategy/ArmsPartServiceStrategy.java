...
@Service
public class ArmsPartServiceStrategy implements PartServiceStrategy<GundamInfoArms> {

    private final GundamInfoArmsRepository repository;

    public ArmsPartServiceStrategy(GundamInfoArmsRepository repository) {
        this.repository = repository;
    }

    @Override
    public List<GundamInfoArms> findByMobileSuitNumber(String msNumber) {
        return repository.findByMobileSuitNumberOrderByPartsIndex(msNumber);
    }
    
    @Override
    public GundamInfoArms findByMsNumberAndPartName(String msNumber, String partName) {
    ...
    public void save(String msNumber, SaveMobileSuitPartsRequest.PartInfo info) {
    	GundamInfoArms entity = new GundamInfoArms();
    ...
    public void update(String msNumber, SaveMobileSuitPartsRequest.PartInfo info) {
    	GundamInfoArms entity = repository.findByMobileSuitNumberAndPartsNameOrderByPartsIndex(
